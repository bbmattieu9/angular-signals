...
import {LoadingIndicatorComponent} from "@app/loading/loading.component";
import {FormBuilder, ReactiveFormsModule, Validators} from '@angular/forms';
import {CourseCategoryComboboxComponent} from "@app/course-category-combobox/course-category-combobox.component";
...
export class EditCourseDialogComponent {
  ...
  async saveCourse(courseId: string, changes: Partial<Course>) {
    try {
      const updateCoursed = await this.coursesService.saveCourse(courseId, changes);
      this.dialogRef.close(updateCoursed);
    } catch (error) {
      console.error(error);
